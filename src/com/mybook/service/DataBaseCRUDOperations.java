...
import com.mybook.DBConnection;
import com.mybook.Person;
import com.mybook.utility.UserInputs;
import com.mybook.utility.ValidateInputs;
...
public class DataBaseCRUDOperations {
    ...
    private String firstName, lastName, address, city, state, phone, zip, email;
    ...
    public List<Person> getDataFromDB() {
        ...
        try (Connection con = DBConnection.getConnection()) {
            ...
            while (result.next()) {
                ...
                personList.add(new Person(firstName, lastName, address, city, state, zip, phone, email));
            }
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
